...
extern struct crush_font *crush_font_context_get_by_id_string(struct crush_font_context *context, uint8_t *id_string);
...
static inline struct crush_font *crush_font_get_by_id_string(uint8_t *id_string)
{
        return crush_font_context_get_by_id_string(crush_font_context(), id_string);
}
