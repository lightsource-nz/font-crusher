...
uint8_t crush_context_init(struct light_command *cmd_parent)
{
        ...
        light_cli_register_subcommand(cmd_context, COMMAND_CONTEXT_NEW_NAME, COMMAND_CONTEXT_NEW_DESCRIPTION, do_cmd_context_new);
        light_cli_register_subcommand(cmd_context, COMMAND_CONTEXT_SET_NAME, COMMAND_CONTEXT_SET_DESCRIPTION, do_cmd_context_set);
        light_cli_register_subcommand(cmd_context, COMMAND_CONTEXT_PUSH_NAME, COMMAND_CONTEXT_PUSH_DESCRIPTION, do_cmd_context_push);
        light_cli_register_subcommand(cmd_context, COMMAND_CONTEXT_POP_NAME, COMMAND_CONTEXT_POP_DESCRIPTION, do_cmd_context_pop);
