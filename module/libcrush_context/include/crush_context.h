...
extern struct light_command *crush_cmd_context_get_command(void);
extern struct light_command *crush_cmd_context_get_subcommand_new(void);
extern struct light_command *crush_cmd_context_get_subcommand_set(void);
extern struct light_command *crush_cmd_context_get_subcommand_push(void);
extern struct light_command *crush_cmd_context_get_subcommand_pop(void);
